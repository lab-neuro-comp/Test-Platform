...
namespace TestPlatform
{
    public partial class FormImgConfig : UserControl
    {
        ...
        {
                FormDefine defineFilePath = defineFilePath = new FormDefine(LocRM.GetString("imageList", currentCulture), FileManipulation._listFolderName, "dir","_image",true, false);
